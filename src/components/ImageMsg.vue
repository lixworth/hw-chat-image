...
<template>
  <div class="flex items-start gap-2.5">
    <div class="flex flex-col gap-1">
      <div class="flex flex-col w-full max-w-[326px] leading-1.5 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
        <div class="flex items-center space-x-2 rtl:space-x-reverse mb-2">
          <span class="text-sm font-semibold text-gray-900 dark:text-white">HW_AI</span>
        ...
        <div class="group relative my-2.5">
          ...
          <img src="./../assets/00015-897584566.jpg" class="rounded-lg">
        </div>
      </div>
    </div>
